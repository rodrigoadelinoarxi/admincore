...
============================
Fiscal Position Contact Type
============================

* Fiscal Positions with filter by contact type

* The contact type is get from the parent partner (if exists a parent)

* If the company is within EU and the partner or the delivery is outside of EU, apply national tax. (False Triangular Operations)
